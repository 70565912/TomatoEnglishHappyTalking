...
## 最新版本 · v1.8.3 窗口状态与绘本转场（2026-09-23）

- Windows 记住窗口位置、大小和最大化状态。
- 听力与歌曲的绘本切页，以及视频导出，共用同一套转场；`pageCurl` 为正式效果。
- 分句求解器仍是 `syntax_solver_v3_11`。已保存文章不会自动重分句。

[查看 v1.8.3 发布说明](docs/releases/v1.8.3.md) ·
[查看变更记录](docs/change_log.md) ·
[查看 v1.8.2 分句说明](docs/releases/v1.8.2.md)
