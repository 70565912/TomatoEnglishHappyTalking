...
| Local subtitle alignment / Volc cloud timeline | MMS CTC was a replacement candidate on 3/4 English samples at mean CPU RTF about 0.88; the hard long-Suno case still requires cloud-timeline fallback (eval baseline was labeled BigASR; current product prefers SeedASR) | [Overview](docs/archive/ctc_forced_aligner_subtitle_eval_20260801/README.md) · [Round 1](docs/archive/ctc_forced_aligner_subtitle_eval_20260801/reports/summary.md) · [Round 2](docs/archive/ctc_forced_aligner_subtitle_eval_20260801/reports/summary_round2.md) |
