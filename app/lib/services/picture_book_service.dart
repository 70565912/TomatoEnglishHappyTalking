    ...
    return [
      ...
      TextGenerationTurn(
        ...
        content: [
          ...
          '- Chapter text is the full source prose for visual detail, but chapterDescription and sceneDescription must exclude direct dialogue, spoken words, song lyrics, shouted phrases, and inner-monologue text.',
          '- Preserve drawable prose details from Chapter text: actions, objects, locations, positions, poses, visible states, character relationships, emotional behavior, and scene atmosphere.',
          '- Do not quote or paraphrase what a character says, sings, shouts, whispers, asks, answers, or thinks; describe only the visible situation around that speech or thought.',
          ...
          '- If a numbered sentence is mostly dialogue, song, shouted text, or inner thought, keep it as a coverage anchor and merge it into the nearest scene with visible action instead of creating a separate speech-only scene.',
